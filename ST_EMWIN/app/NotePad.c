...
//#define KEYBOARD320x240
//#define KEYBOARD320x480
#define KEYBOARD320x360
//#define KEYBOARD480x272
//#define KEYBOARD800x480

#define X_ST      200
#define Y_ST      0

#ifdef KEYBOARD320x240
#define X_RATE		1
#define Y_RATE		1
#elif defined (KEYBOARD320x360)
#define X_RATE		1
#define Y_RATE		1.5
#elif defined(KEYBOARD480x272)
#define X_RATE		1.5
#define Y_RATE		1.13
#elif defined(KEYBOARD320x480)
#define X_RATE		1
#define Y_RATE		2
#elif defined(KEYBOARD800x480)
#define X_RATE		2.5
#define Y_RATE		2
#endif
/*********************************************************************
...
static const BUTTON_DATA _aButtonData[] = {
  {  6*X_RATE,   6*Y_RATE,  24*X_RATE, 24*Y_RATE, "Q" },
  { 32*X_RATE,   6*Y_RATE,  24*X_RATE, 24*Y_RATE, "W" },
  { 58*X_RATE,   6*Y_RATE,  24*X_RATE, 24*Y_RATE, "E" },
  { 84*X_RATE,   6*Y_RATE,  24*X_RATE, 24*Y_RATE, "R" },
  {110*X_RATE,   6*Y_RATE,  24*X_RATE, 24*Y_RATE, "T" },
  {136*X_RATE,   6*Y_RATE,  24*X_RATE, 24*Y_RATE, "Y" },
  {162*X_RATE,   6*Y_RATE,  24*X_RATE, 24*Y_RATE, "U" },
  {188*X_RATE,   6*Y_RATE,  24*X_RATE, 24*Y_RATE, "I" },
  {214*X_RATE,   6*Y_RATE,  24*X_RATE, 24*Y_RATE, "O" },
  {240*X_RATE,   6*Y_RATE,  24*X_RATE, 24*Y_RATE, "P" },
  {266*X_RATE,   6*Y_RATE,  24*X_RATE, 24*Y_RATE, "="},
  {292*X_RATE,   6*Y_RATE,  24*X_RATE, 24*Y_RATE, "\x8", _DrawBkSpc },
  { 16*X_RATE,  34*Y_RATE,  24*X_RATE, 24*Y_RATE, "A" },
  { 42*X_RATE,  34*Y_RATE,  24*X_RATE, 24*Y_RATE, "S" },
  { 68*X_RATE,  34*Y_RATE,  24*X_RATE, 24*Y_RATE, "D" },
  { 94*X_RATE,  34*Y_RATE,  24*X_RATE, 24*Y_RATE, "F" },
  {120*X_RATE,  34*Y_RATE,  24*X_RATE, 24*Y_RATE, "G" },
  {146*X_RATE,  34*Y_RATE,  24*X_RATE, 24*Y_RATE, "H" },
  {172*X_RATE,  34*Y_RATE,  24*X_RATE, 24*Y_RATE, "J" },
  {198*X_RATE,  34*Y_RATE,  24*X_RATE, 24*Y_RATE, "K" },
  {224*X_RATE,  34*Y_RATE,  24*X_RATE, 24*Y_RATE, "L" },
  {250*X_RATE,  34*Y_RATE,  24*X_RATE, 24*Y_RATE, ";"},
  {276*X_RATE,  34*Y_RATE,  40*X_RATE, 24*Y_RATE, "\x0d", _DrawReturn },
  {  6*X_RATE,  62*Y_RATE,  24*X_RATE, 24*Y_RATE, "\x19", _DrawShift },
  { 32*X_RATE,  62*Y_RATE,  24*X_RATE, 24*Y_RATE, "Z" },
  { 58*X_RATE,  62*Y_RATE,  24*X_RATE, 24*Y_RATE, "X" },
  { 84*X_RATE,  62*Y_RATE,  24*X_RATE, 24*Y_RATE, "C" },
  {110*X_RATE,  62*Y_RATE,  24*X_RATE, 24*Y_RATE, "V" },
  {136*X_RATE,  62*Y_RATE,  24*X_RATE, 24*Y_RATE, "B" },
  {162*X_RATE,  62*Y_RATE,  24*X_RATE, 24*Y_RATE, "N" },
  {188*X_RATE,  62*Y_RATE,  24*X_RATE, 24*Y_RATE, "M" },
  {214*X_RATE,  62*Y_RATE,  24*X_RATE, 24*Y_RATE, "," },
  {240*X_RATE,  62*Y_RATE,  24*X_RATE, 24*Y_RATE, "." },
  {266*X_RATE,  62*Y_RATE,  24*X_RATE, 24*Y_RATE, "/" },
  {292*X_RATE,  62*Y_RATE,  24*X_RATE, 24*Y_RATE, "\x19", _DrawShift },
  {  6*X_RATE,  90*Y_RATE,  37*X_RATE, 24*Y_RATE, "Ctrl" },
  { 45*X_RATE,  90*Y_RATE,  37*X_RATE, 24*Y_RATE, "Alt" },
  { 84*X_RATE,  90*Y_RATE, 154*X_RATE, 24*Y_RATE, " " },
  {240*X_RATE,  90*Y_RATE,  37*X_RATE, 24*Y_RATE, "Alt Gr" },
  {279*X_RATE,  90*Y_RATE,  37*X_RATE, 24*Y_RATE, "Ctrl" },
};
//#endif
#if 0
#ifdef KEYBOARD480x272
...
#ifdef KEYBOARD320x480
#endif

#ifdef KEYBOARD800x480
...
static void _cbKeyPad(WM_MESSAGE * pMsg) {
  ...
  case WM_PAINT:
	...
	GUI_DrawGradientV(1, 1, xSize - 2, ySize - 2, GUI_YELLOW, GUI_LIGHTYELLOW);
    break;
...
//      // Continue...
//      //
//      WM_RestartTimer(pMsg->Data.v, Delay);//重启定时器  注意pMsg->Data.v存放了定时器的句柄
//    }
    break;
  case WM_CREATE:
    //
    ...
    //
    Index = Pressed = 0;
   // WM_CreateTimer(hWin, 0, 3000, 0);//创建一个定时器  
    break;
  default:
    WM_DefaultProc(pMsg);
  }
...
static void _cbBk(WM_MESSAGE * pMsg) {
  ...
  // GUI_DrawGradientV(0, 0, 799, 479, COLOR_BACK0, COLOR_BACK1);
...
*       MainTask
*/
void MainTask_NotePad(void) {
  WM_HWIN hKeypad;
volatile  WM_HWIN hFrame=0;
  WM_HWIN hMulti;
  WM_HWIN hAnim;
  ...
  // Initialize emWin
  //
 	 WM_SetCreateFlags(WM_CF_MEMDEV);//使能存储设备
  //GUI_Init();
  WM_SetCallback(WM_HBKWIN, _cbBk);//设置背景回调函数
  //GUI_CURSOR_Show();
  //
  // Set widget default settings for keypad
  //
	BUTTON_SetReactOnLevel();
  BUTTON_SetDefaultSkin(_DrawSkinFlex_BUTTON);//设置按钮皮肤
	//BUTTON_SetDefaultBkColor(GUI_BLUE,0);
  //
  // Create keypad   //
  //
  
  hKeypad = WM_CreateWindowAsChild(X_ST+0, Y_ST+120*Y_RATE, 320*X_RATE, 120*Y_RATE, WM_HBKWIN, WM_CF_HIDE|WM_CF_STAYONTOP, _cbKeyPad, 0); //创建键盘window  不显示
#if 0
	#ifdef KEYBOARD320x240
  hKeypad = WM_CreateWindowAsChild(0, 120, 320, 120, WM_HBKWIN, WM_CF_HIDE|WM_CF_STAYONTOP, _cbKeyPad, 0); //创建键盘window  不显示
  #endif
	#ifdef KEYBOARD480x272
	
	hKeypad = WM_CreateWindowAsChild(0, 120*1.13, 480, 120*1.13, WM_HBKWIN, WM_CF_HIDE|WM_CF_STAYONTOP, _cbKeyPad, 0); //创建键盘window  不显示
	#endif
	
		#ifdef KEYBOARD800x480
	
	hKeypad = WM_CreateWindowAsChild(0, 120*2, 800, 120*2, WM_HBKWIN, WM_CF_HIDE|WM_CF_STAYONTOP, _cbKeyPad, 0); //创建键盘window  不显示
	#endif
#endif
 // while (1) {
 //   GUI_Delay(2500);
    ...
    if (hFrame == 0) {
      ...
      // Create frame window
      //
      hFrame = FRAMEWIN_CreateEx(X_ST+0, Y_ST+0, 320*X_RATE, 120*Y_RATE, WM_HBKWIN, WM_CF_SHOW, 0, 0, "Notepad", 0);
      #if 0
			#ifdef KEYBOARD320x240
      hFrame = FRAMEWIN_CreateEx(0, 0, 320, 120, WM_HBKWIN, WM_CF_SHOW, 0, 0, "Notepad", 0);
			 #endif
				#ifdef KEYBOARD480x272
      hFrame = FRAMEWIN_CreateEx(0, 0, 480, 120*1.13, WM_HBKWIN, WM_CF_SHOW, 0, 0, "Notepad", 0);
			 #endif
				#ifdef KEYBOARD800x480
      hFrame = FRAMEWIN_CreateEx(0, 0, 800, 120*2, WM_HBKWIN, WM_CF_SHOW, 0, 0, "Notepad", 0);
			 #endif
			 #endif
      FRAMEWIN_SetTextColor(hFrame, GUI_BLACK);
      FRAMEWIN_SetFont(hFrame, &GUI_Font20_AA4);
      FRAMEWIN_SetClientColor(hFrame, GUI_WHITE);
//			FRAMEWIN_SetBarColor(hFrame,1,GUI_BLUE);
//					FRAMEWIN_SetBarColor(hFrame,0,GUI_BLUE);
    //  FRAMEWIN_AddCloseButton(hFrame, FRAMEWIN_BUTTON_RIGHT, 0);
			//WM_SetFocus(hFrame); //焦点设置在这
      //
      ...
      MULTIEDIT_SetWrapWord(hMulti);   //使能换行
      MULTIEDIT_SetFont(hMulti, GUI_FONT_16B_ASCII);
      WM_SetFocus(hMulti); //焦点设置在这
    }
    //
    // Use effect functions to make editor and keypad visible
    //
    GUI_MEMDEV_ShiftInWindow(hFrame, 4000, GUI_MEMDEV_EDGE_LEFT);
    GUI_MEMDEV_ShiftInWindow(hKeypad, 4000, GUI_MEMDEV_EDGE_BOTTOM);
    GUI_Delay(500);
    //
    // Do keyboard animation by a hidden animation window which emits PID events
    //
    WM_SendMessageNoPara(hKeypad, APP_INIT_LOWERCASE);//像窗体发送一个没有参数的消息 在这里就是像键盘窗体发送消息
    ...
    //
    GUI_MEMDEV_ShiftOutWindow(hKeypad, 1500, GUI_MEMDEV_EDGE_BOTTOM);
    if (WM_IsWindow(hFrame)) {
      GUI_MEMDEV_ShiftOutWindow(hFrame, 1500, GUI_MEMDEV_EDGE_RIGHT);
